...
RESOURCES += src/qt/zencoin.qrc src/qt/zencoin_locale.qrc

TRANSLATIONS += src/qt/locale/zencoin_bg.ts \
                src/qt/locale/zencoin_de.ts \
                src/qt/locale/zencoin_en.ts \
                src/qt/locale/zencoin_es.ts \
                src/qt/locale/zencoin_fi.ts \
                src/qt/locale/zencoin_fr.ts \
                src/qt/locale/zencoin_it.ts \
                src/qt/locale/zencoin_ja.ts \
                src/qt/locale/zencoin_pl.ts \
                src/qt/locale/zencoin_pt.ts \
                src/qt/locale/zencoin_ru.ts \
                src/qt/locale/zencoin_sk.ts \
                src/qt/locale/zencoin_sv.ts \
                src/qt/locale/zencoin_vi.ts \
                src/qt/locale/zencoin_zh_CN.ts \
                src/qt/locale/zencoin_zh_TW.ts
