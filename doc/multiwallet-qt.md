...
In order to support loading of multiple wallets in zencoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zencoin.cpp.
...
Changes to zencoin.cpp
----------------------
zencoin.cpp is the entry point into zencoin-qt, and as such, will require some minor modifications to provide hooks for
