...
#   c) node1 mines 32 blocks, so now node 0 has 60001zencoin, node 1 has 4250zencoin, node2 has none.
#   d) node0 sends 601 zencoin to node2, in two transactions (301 zencoin, then 300 zencoin).
