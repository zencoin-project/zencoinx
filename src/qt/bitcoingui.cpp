...
QFontDatabase::addApplicationFont(":/fonts/zencoin_font");

QString windowTitle = tr("zencoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zencoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about zencoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zencoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the zencoin Core help message to get a list with possible zencoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zencoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zencoin network", "", count));
}
...
{
    QString strTitle = tr("zencoin Core"); // default title
