...
/** Utility functions used by the zencoin Qt UI.
 */
namespace GUIUtil
{
...
// Render zencoin addresses in monospace font
...
// Parse "zencoin:" URI into recipient object, return true on successful parsing
