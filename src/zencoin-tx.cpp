...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zencoin Core zencoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zencoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zencoin transaction") + "\n" +
                               "  zencoin-tx [options] -create [commands]   " + _("Create hex-encoded zencoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zencoin transaction
